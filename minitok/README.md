...
1. Rode o projeto flutter através do comando `flutter run -d chrome --web-browser-flag "--disable-web-security"`
2. Registre-se e logue, para conseguir navegar pelo projeto.
